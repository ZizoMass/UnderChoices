...
namespace Articy.Underchoices.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.Underchoices.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        {
            Articy.Underchoices.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.Underchoices.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.Underchoices.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.Underchoices.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.Underchoices.Templates.DefaultMainCharacterTemplateTemplate();
